                  ...
                  if (
                    ...
                    return (
                      <InlineNotification
                        ...
                        title={
                          errorNotification.title ? errorNotification.title : ''
                        }
                      />
                    );
                  }
                                  ...
                                  <Form onSubmit={saveBillingInformation}>
                                    <Stack orientation={'vertical'} gap={5}>
                                      ...
                                      <TextInput
                                        ...
                                        value={postalCode_bi}
                                        onChange={e => {
                                          setPostalCode_bi(e.target.value);
                                          if (
                                            typeof errorNotification ==
                                              'object' &&
                                            Object.keys(errorNotification)
                                      ...
                                      <TextInput
                                        ...
                                        onChange={e => {
                                          setPhoneNumber_bi(e.target.value);
                                          if (
                                            typeof errorNotification ==
                                              'object' &&
                                            Object.keys(errorNotification)
                                  ...
                                  <Form onSubmit={saveTaxInformation}>
                                    <Stack orientation={'vertical'} gap={5}>
                                      ...
                                      <TextInput
                                        ...
                                        value={taxNumber_ti}
                                        onChange={e => {
                                          setTaxNumber_ti(e.target.value);
                                          if (
                                            typeof errorNotification ==
                                              'object' &&
                                            Object.keys(errorNotification)
                                  ...
                                  <Form onSubmit={saveCreditCardInformation}>
                                    <Stack orientation={'vertical'} gap={5}>
                                      <TextInput
                                        ...
                                        onChange={e => {
                                          setCardNumber_cci(e.target.value);
                                          if (
                                            typeof errorNotification ==
                                              'object' &&
                                            Object.keys(errorNotification)
                                      ...
                                      <TextInput
                                        ...
                                        onChange={e => {
                                          setExpiryDate_cci(e.target.value);
                                          if (
                                            typeof errorNotification ==
                                              'object' &&
                                            Object.keys(errorNotification)
                                      ...
                                      <TextInput
                                        ...
                                        onChange={e => {
                                          setSecurity_cci(e.target.value);
                                          if (
                                            typeof errorNotification ==
                                              'object' &&
                                            Object.keys(errorNotification)
