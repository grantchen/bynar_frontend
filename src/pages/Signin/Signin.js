            ...
            <div className="inner">
                      ...
                      if (askForPassword) {
                        return (
                          <p className="headingSubtitle">
                            <Link
                              className="backToEmailLink"
                              onClick={setEmailInputMode}>
                              <ArrowLeft className="backToEmailLinkIcon" />{' '}
                              {email}
                            </Link>
                          </p>
                        );
                  ...
                  <Form onSubmit={handleSubmit}>
                    <Stack orientation={'vertical'} gap={7}>
                      {askForPassword ? (
                        ...
                        <div>
                          <FormLabel className={'emailInputLabel'}>
                            E-Mail{' '}
                      ...
                      {loading ? (
                        <InlineLoading
                          description={
                            loadingSuccess ? 'Done!' : 'Please wait...'
                          }
                          status={loadingSuccess ? 'finished' : 'active'}
                        />
                      ) : (
                        <Button
              ...
              <div className="fields-container bottom-link-container">
                <p className="register-text body-01">
                  ...
                  <Link href="/signup">Create an IBMid</Link>
                </p>
              </div>
            </div>
          </div>
